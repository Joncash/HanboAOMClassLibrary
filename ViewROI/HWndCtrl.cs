...
namespace ViewROI
{
    ...
    public class HWndCtrl
    {
        ...
        public void resetWindow()
        {
            ...
            ///**/
            //var wRatio = imageWidth / 512;
            //var hRatio = imageHeight / 512;
            //var ratio = Math.Max(wRatio, hRatio);
            //var w = (int)(imageWidth / ratio);
            //var h = (int)(imageHeight / ratio);
        ...
        public void repaint(HalconDotNet.HWindow window)
        {
            try
            {
                ...
                if (prevScaleC == 1.0)
                {
                    ...
                    {
                        HOperatorSet.DispArrow(window, arrowModel.CenterY, arrowModel.CenterX, arrowModel.FirstArrowY, arrowModel.FirstArrowX, 5);
                        HOperatorSet.DispArrow(window, arrowModel.CenterY, arrowModel.CenterX, arrowModel.SecArrowY, arrowModel.SecArrowX, 5);
                    }
