...
namespace Habo.SDMS.ALGO
{
	public class SDMS_A8 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 924.86, f_ROI_Col = 610.137;
			...
			HTuple s_ROI_Row = 851.99, s_ROI_Col = 685.627;
			...
			//Angle
			HTuple trainModelAngle = 0;
			HTuple angleOffset = trainModelAngle - hv_Img_Rotate_Angle;
			...
			roiF.MakeROI(f_ROI_Cur_Row, f_ROI_Cur_Col, angleOffset, 200, 50);

			var roiS = new ROIRectangle2() { ROIMeasureType = MeasureType.Line };
			//roiS.MakeROI(400, 1041, 0, 13.3, 75.7);
			roiS.MakeROI(s_ROI_Cur_Row, s_ROI_Cur_Col, angleOffset, 38.72, 68.23);
