...
{
	public class SDMS_B10 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_angle = 1.57;
			HTuple f_ROI_Row = 218.35, f_ROI_Col = 739.03;
			HTuple f_ROI_Length1 = 57.769, f_ROI_Length2 = 186.980;
			...
			//第二個 線段 ROI
			HTuple s_angle = 1.57;
			HTuple s_ROI_Length1 = 72.789;
			HTuple s_ROI_Length2 = 46.215;
			HTuple s_ROI_Row = 770.16, s_ROI_Col = 629.94;
