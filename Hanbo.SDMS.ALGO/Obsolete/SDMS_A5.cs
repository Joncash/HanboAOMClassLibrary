...
namespace Habo.SDMS.ALGO
{
	public class SDMS_A5 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 416, f_ROI_Col = 998;
			...
			HTuple s_ROI_Row = 400, s_ROI_Col = 1041;
			...
			roiF.MakeROI(f_ROI_Cur_Row, f_ROI_Cur_Col, angleOffset, 26.5, 71.2);

			var roiS = new ROIRectangle2() { ROIMeasureType = MeasureType.Line };
			//roiS.MakeROI(400, 1041, 0, 13.3, 75.7);
			roiS.MakeROI(s_ROI_Cur_Row, s_ROI_Cur_Col, angleOffset, 13.3, 75.7);
