...
namespace Habo.SDMS.ALGO.MSD
{
	public class SDMS_B : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 312.212890625;
			HTuple f_ROI_Col = 1392.8137254902;
			...
			//第二個 線段 ROI
			HTuple s_ROI_Row = 1281.55859375;
			HTuple s_ROI_Col = 1403.31045751634;
			HTuple s_angle = -1.5707963267949;
			HTuple s_ROI_Length1 = 60.4609375;
			HTuple s_ROI_Length2 = 160.464052287582;
