...
namespace Habo.SDMS.ALGO.MSD
{
	public class SDMS_A8 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 993.673828125;
			HTuple f_ROI_Col = 697.728758169935;
			HTuple f_angle = 0;
			HTuple f_ROI_Length1 = 28.4575163398694;
			HTuple f_ROI_Length2 = 78.353515625;
			...
			//第二個 線段 ROI
			HTuple s_ROI_Row = 977.392578125;
			HTuple s_ROI_Col = 758.709150326797;
			HTuple s_angle = 0;
			HTuple s_ROI_Length1 = 45.7352941176471;
			HTuple s_ROI_Length2 = 94.634765625;
