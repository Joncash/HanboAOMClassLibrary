...
namespace Hanbo.CalibrationModule
{
	public class QualityProcedures
	{
									  ...
									  out HTuple hv_SizeScore)
		{
			...
			HTuple hv_Number, hv_Row1 = new HTuple(), hv_Column1 = new HTuple();
			HTuple hv_Phi1 = new HTuple(), hv_Length1 = new HTuple(), hv_Length2 = new HTuple();
			HTuple hv_Area = new HTuple(), hv_Row = new HTuple(), hv_Column = new HTuple();
			HTuple hv_MinRatio, hv_MaxRatio, hv_Ratio;
										 ...
										 HTuple hv_CoordAxesLength)
		{
			...
			HTuple hv_Pointer, hv_Type, hv_Width, hv_Height;
			HTuple hv_OldBG, hv_WindowHandle;

			// Initialize local and output iconic variables 
			HOperatorSet.GenEmptyObj(out ho_CoordSystemRegion);
			HOperatorSet.GenEmptyObj(out ho_CoordSystemImage);

			HOperatorSet.GetImagePointer1(ho_ImageReference, out hv_Pointer, out hv_Type,
				out hv_Width, out hv_Height);
