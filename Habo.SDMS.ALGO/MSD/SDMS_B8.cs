...
namespace Habo.SDMS.ALGO.MSD
{
	public class SDMS_B8 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 347.23828125;
			HTuple f_ROI_Col = 1372.45098039216;
			HTuple f_angle = 1.5707963267949;
			HTuple f_ROI_Length1 = 72.83984375;
			HTuple f_ROI_Length2 = 40.1568627450981;
			...
			//第二個 線段 ROI
			HTuple s_ROI_Row = 455.2421875;
			HTuple s_ROI_Col = 1371.19607843137;
			HTuple s_angle = 1.5707963267949;
			HTuple s_ROI_Length1 = 41.443359375;
			HTuple s_ROI_Length2 = 37.6470588235295;
			...
			mResult = DistanceHelper.PointToPoint(lineF, lineS, this.hv_AllModelAngle, LineDirection.Vertical);
