...
namespace Habo.SDMS.ALGO.MSD
{
	public class SDMS_B7 : IMeasure
	{
		public MeasureResult Action()
		{
			...
			//第一個 線段 ROI
			HTuple f_ROI_Row = 418.822265625;
			HTuple f_ROI_Col = 1194.25490196078;
			HTuple f_angle = 1.5707963267949;
			HTuple f_ROI_Length1 = 51.490234375;
			...
			//第二個 線段 ROI
			HTuple s_ROI_Row = 448.962890625;
			HTuple s_ROI_Col = 1259.50980392157;
			HTuple s_angle = 1.5707963267949;
			HTuple s_ROI_Length1 = 60.28125;
			HTuple s_ROI_Length2 = 37.6470588235293;
